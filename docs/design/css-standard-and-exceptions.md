...
|-------------------|-------------------------|-------------------------|
| SearchHistory     | .search-history-approval-dropdown trigger + panel: same background as editable fields (#fff) | req 20260317-search-history-screen-improvements (decryption-approval not read-only look) |
